...
namespace Oact\Includes\MetaBoxes;

use Oact\Helpers\Helpers as Helper;
...
class Sample {
  ...
  public function html( $post ) {
    ...
    ?>
      <div class="oact-field">
        <div class="oact-label">
          <label for="sample"><?php echo esc_html__( 'Serial No:', 'oact' ); ?></label>
        </div>
        <div class="oact-input">
